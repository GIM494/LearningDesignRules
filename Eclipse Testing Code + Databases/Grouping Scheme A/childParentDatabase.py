...
def makeParentList(classTree):

    parentClassList = []
    #print("In makeParentList")
    # What a class extends
    classExt = classTree.findall(".//src:super/src:extends", nameSpace)

    #print(classExt)
    for classExtends in classExt:
...
def addParentChildRelations(classTree, id_no, parentClassList):
    i = 1
    j = 1
    ...
    for clsRoot in classTree.findall(".//src:class", nameSpace):
        ...
        if clsName in parentClassList:
            ...
            for subCL in classTree.findall(".//src:class", nameSpace):
                ...
                if classExtends != None:
                    clsNm = (classExtends.find('src:name', nameSpace))
                    if clsNm.text is None:
                        clsN = (clsNm.find('src:name', nameSpace)).text
                    else:
                        clsN = clsNm.text
                    ...
                    if clsN is not None and clsN == clsName:
                        ...
                        if len(constructor) > 0:
                            for constr in constructor:
                                ...
                                for p in paramsList:
                                    ...
                                    name = "child class defines constructor with parameter of type " + paramType.text
                                    if name not in attributeList:
                                        attributeList[name] = id_no
                                        id_no += 1
                        ...
                        # What a class extends
                        classExtendsName = "child class extends class " + clsName
...
def findParentChildRelations(peripheralClassRoot, allAttributes, parentClassList, fileName):
            ...
            for subCL in peripheralClassRoot.findall(".//src:class", nameSpace):
                ...
                if classExtends != None:
                    ...
                    if clsN is not None and clsN == clsName:
                        ...
                        fileN = fileName + "_subClassOf"+ clsName + ".txt"
